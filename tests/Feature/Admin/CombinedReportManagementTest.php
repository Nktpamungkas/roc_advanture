...
class CombinedReportManagementTest extends TestCase
{
    ...
    public function test_staff_cannot_access_financial_report_page(): void
    {
        $staff = $this->createUserWithRole(RoleNames::STAFF);

        $this->actingAs($staff)->get(route('admin.financial-reports.index'))->assertForbidden();
    }

    public function test_admin_toko_can_open_financial_report_page(): void
    {
    ...
    public function test_financial_report_merges_rental_sale_and_combined_transactions(): void
    {
        $admin = $this->createUserWithRole(RoleNames::ADMIN_TOKO);
